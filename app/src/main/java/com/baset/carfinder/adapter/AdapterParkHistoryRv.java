...
private TextView carNameandColor;
...
private TextView todayCheck;
        public ViewHolderParkedPlacesRv(View itemView) {
            super(itemView);
            carNameandColor=itemView.findViewById(R.id.itemview_tvCarNameandColor);
        ...
        public void bindData(final ModelParkHistory parkHistory){
            carNameandColor.setText(parkHistory.getCarName()+" "+parkHistory.getCarColor());
