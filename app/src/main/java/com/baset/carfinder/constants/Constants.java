...
public interface Constants {
    ...
    public static final String KEY_PREFERENCE_CAR_IMAGE="carImageDirectory";
    public static final String KEY_PREFERENCE_CAR_NAME="carName";
    public static final String KEY_PREFERENCE_PLAQUE="CarPlaque";
    public static final String KEY_PREFERENCE_MODEL="carModel";
    public  static final String KEY_PREFERENCE_COLOR="carColor";
